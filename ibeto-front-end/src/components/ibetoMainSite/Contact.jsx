   ...
   return (
      <div className='container-fluid ' id='Contact'>
         ...
         <div class='profile-container row '>
            <div data-aos='fade-in' class='profile-card only-start mb-4 col-lg-3 col-md-6 col-sm-12'>
            ...
            <div data-aos='fade-in' data-aos-delay='300' class='profile-card mb-4 only-start col-lg-3 col-md-6 col-sm-12'>
               <img src='https://i.imgur.com/S4GNFIW.jpg' alt='image2' class='profile-icon' />
               <div class='profile-name'>Mabel Max</div>
               <div class='profile-position'>Web Developer</div>
            </div>
            <div data-aos='fade-in' data-aos-delay='600' class='profile-card only-start mb-4 col-lg-3 col-md-6 col-sm-12'>
