   ...
   return (
      <div className='container ' id='Contact'>
         ...
         <div class='profile-container row '>
            <div data-aos='fade-in' class='profile-card only-start col-md-3 col-sm-12'>
            ...
            <div data-aos='fade-in' data-aos-delay='300' class='profile-card only-start  col-md-3 col-sm-12'>
            ...
            <div data-aos='fade-in' data-aos-delay='600' class='profile-card only-start col-md-3 col-sm-12'>
