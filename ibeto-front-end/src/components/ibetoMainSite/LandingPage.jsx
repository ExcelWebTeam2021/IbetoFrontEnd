         ...
         <section class='hero'>
            <div class='container'>
               <div class='hero-inner'>
                  <div>
                     <h1 class='hero-title h2-mobile mt-0 '>Landing template for startups</h1>
                     <p class='hero-paragraph '>Our landing page template works for all the devices, so you only have to setup it once, and get beautiful results forever.</p>
                     <p>
                  ...
                  <div class='hero-illustration '>
                     <svg className='landing-page-section' width='528' height='413' viewBox='0 0 528 413' xmlns='http://www.w3.org/2000/svg'>
                        <defs>
