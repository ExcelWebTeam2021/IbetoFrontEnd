   ...
   return (
      <div className='container-fluid ' id='EventFormat'>
         ...
         <div className='row event-format'>
            <div data-aos="fade-down" class='col-md-3 col-sm-10 phase'>
            ...
            <div data-aos="fade-down" data-aos-delay="300" class='col-md-3 col-sm-10 phase'>
            ...
            <div data-aos="fade-down" data-aos-delay="600" class='col-md-3 col-sm-10 phase'>
